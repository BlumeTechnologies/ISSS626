...
```{r}
#useroads = c("motorway", "trunk","primary","secondary","tertiary","unclassified","residential","service")
...
#roads_clipped <- st_intersection(network, u)
```
```{r}
# now 'roads_clipped' will only contain the roads that are within your study area
#network_clipped2 = network[st_within(network, u, sparse = FALSE),]
